...
if __name__ == '__main__':
    ...
    dataset = MyDataset(root="../data", use_ideal_target=False, percent=10 ,transform=None, target_tarnsform=None)
...
'''
    ...
    for epoch in range(1):
        ...
        torch.save(model.classifier.state_dict(), 'weight_of_mixup_training/checkpoint_{}.pth'.format(epoch))
'''